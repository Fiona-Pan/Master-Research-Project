...
atac<-readRDS("Merge-by-L1-L2-pmat-Seurat.rds")
atac[["ATAC"]] #ChromatinAssay data with 348891 features for 11840 cells
...
atac <- subset(
  ...
  subset = peak_region_fragments > 3000 &
    peak_region_fragments < 170000 &
    pct_reads_in_peaks > 25 &
    blacklist_ratio < 0.0005 &
    nucleosome_signal < 4 &
    TSS.enrichment > 1.0
)

atac #348891 features across 11840 samples within 1 assay 
...
# remove cluster<100
atac<-atac[,Idents(atac) %in% names(table(Idents(atac))[which(table(Idents(atac))>100)])]
atac #348891 features across 10134 samples within 1 assay
...
saveRDS(atac,"Merged-Integrated-by-pmat.Seurat.Obj.rds")
